...
1. **编剧自由发挥**：流水线要求主角写「两处瑕疵（磨损/尘土/伤痕）」，温情题材下编剧给奶奶加了"袖口面粉、手上旧伤"，定妆图画成了满身黄渍、手像受伤；还把缺耳灰白猫改成了三花。
   **修法**：在故事里写一段「外形锁定，照抄不要改」，把模板第 2 段的人物描述原样塞进去，并写明"双手干净，不要伤痕污渍"。
   ...
   ![定妆图对比](character-compare.jpg)

   *左：第 1 次，没锁外形——开衫满是黄渍、双手像受了伤（编剧写的"面粉尘土 + 旧伤痕"），猫还被改成了三花。右：第 3 次，锁定外形后——干净的燕麦色开衫、左肘补丁、挂绳老花镜、双手干净，灰白猫一起入镜（[单张原图](character-run1-rejected.jpg)）。*
   **这条值得单拎出来**：「写瑕疵 = 写真实」在战损动作片里是对的，放到温情题材上会反噬。同样是瑕疵，这里该写的是"手肘补过一块补丁"——是岁月，不是伤害。
