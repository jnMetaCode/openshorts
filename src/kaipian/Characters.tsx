...
export type Card = {
  ...
  portrait: {file: string; source: 'local-flux' | 'upload'; seed: number | null; translated?: boolean; ratio?: string | null} | null;
  history: {file: string; source: string; seed: number | null}[]; stale: boolean; portraitUrl: string | null;
};
...
export const Characters = ({lang, t, selected, onSelect, onCard, ratio = '16:9'}: {lang: string; t: (s: string) => string; selected: string; onSelect: (id: string) => void; onCard?: (c: Card | null) => void; ratio?: string}) => {
