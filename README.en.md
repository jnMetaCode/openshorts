...
| *The One Who Stayed* (grandmother & cat) | AI drama · story + look block from an [ai-shortfilm-prompts template](https://github.com/jnMetaCode/ai-shortfilm-prompts/blob/main/templates/elderly-cat-companion.md) · Agnes · **woman + cat consistent across 3 shots** | 13s | [docs/cases/drama-grandma-cat](docs/cases/drama-grandma-cat/) (zh) |
